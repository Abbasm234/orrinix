...
struct AppDataProbe: StorageProbe {
    ...
    /// Containers owned by specialist probes. Keeping this list shared with
    /// tests prevents the same bytes being counted once as generic app data
    /// and again by a more useful, app-specific recommendation.
    static let coveredContainers: Set<String> = [
